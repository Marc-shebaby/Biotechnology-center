...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="#appointment" class="appointment-btn scrollto"><span class="d-none d-md-inline">Order a</span> Test</a>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
      ...
      <h2>During your time of uncertainty, depend on medilab for <br> the answers you need.</h2>
...
<!--	<section id="about" class="about">
	<div class="slider-image ie-image-only" style="display:none; background-image:url('/wp-content/uploads/2021/04/caris-lifesciences-4-revolution.jpg');"></div>
 <video class="homepage-video" autoplay="" loop="" playsinline="" muted="" poster="/wp-content/uploads/2021/04/caris-lifesciences-4-revolution.jpg">
 <source src="/wp-content/uploads/2021/04/caris-lifesciences-4-revolution.mp4">
 <source src="/wp-content/uploads/2021/04/caris-lifesciences-4-revolution.m4v">
 </video>
 </section> -->
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <h1>Hospitals Associated with Medilab</h1>
          <p>Understanding cancer at the molecular level can lead to better treatment options. Medilab provides cancer patients and oncologists with reliable, high-quality, comprehensive molecular information to deliver on the promise of precision medicine.</p>
        </div>
        ...
        <form action="add_patient.php" method="post" role="form" <!--class="php-email-form"-->
          ...
          <div class="row">
            <div class="col-md-4 form-group mt-3">
              <input type="datetime" name="date" class="form-control datepicker" id="date" placeholder="Order Date" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
...
-->
    ...
    <section id="faq" class="faq section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2>About Medilab</h2>
		  <p class="elementor-heading-title elementor-size-default">Medilab is a leading innovator in molecular science, helping patients, clinicians, researchers, and payors navigate, advance and reinvent cancer care. Our core competencies span multiple critical aspects of the life sciences industry:</p>
		  </p>
		  <div class="elementor-element elementor-element-365001b1 text-larger font-weight-bold elementor-widget elementor-widget-html" data-id="365001b1" data-element_type="widget" data-widget_type="html.default">
				<div class="elementor-widget-container">
			<div class="row">
  <div class="col-6">Molecular Profiling 101</div>
  <div class="col-6">DNA and RNA Sequencing</div>
  <div class="col-6">Biopharma Solutions</div>
  <div class="col-6">Tumor Biomarker Analysis</div>
  <div class="col-6">Research and Innovation</div>
  <div class="col-6">Network Collaboration</div>
</div>		</div>
				</div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  ...
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                    Good working building and some talented people.
                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                  </p>
                </div>
              </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  ...
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                    great multiplatform product in genomic technology this company has been around a long time and has the money to provide outstanding labs.
                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                  </p>
                </div>
              </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  ...
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                Good leadership is always a good investment.
                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                  </p>
                </div>
              </div>
  ...
  <footer id="footer">
    ...
    <div class="footer-top">
     ...
     <!--     <div class="col-lg-3 col-md-6 footer-links">
            <h4>Hospitals associated with Medilab</h4>
            <ul>
